...
# </div>
# 
# In this [Hugging Face](https://huggingface.co/learn/nlp-course/en/chapter12/6?fw=pt) and Unsloth notebook, you will learn to transform Phi 4 (14B) GRPO into a Reasoning model using GRPO.
# 
